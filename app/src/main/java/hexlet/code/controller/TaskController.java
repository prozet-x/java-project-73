...
public class TaskController {
    ...
    public List<Task> getAll(
            @QuerydslPredicate(root = Task.class) @Parameter(description = "Predicate to filter tasks") Predicate predicate,
            @PageableDefault  @Parameter(description = "Contains pagination parameters") Pageable pageable) {
